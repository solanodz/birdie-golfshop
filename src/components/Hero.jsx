        ...
        <div className="min-h-screen">
            <div className="relative h-screen" style={FondoHeroStyle}>
                <div className="p-6 md:p-10 lg:p-8  absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-left">
                    <h1 className="text-5xl md:text-7xl mb-4 lg:text-8xl font-black">
                        Birdie Golfshop.
                    </h1>
                    <h3 className="italic p-1 font-medium text-md md:text-lg lg:text-xl px-2 text-black bg-white w-fit md:mt-4 lg:mt-6">
